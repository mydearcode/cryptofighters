...
- **Moves & Battle Cries**:
  - `diamond_hands`: ["HODL to the moon!", "Diamond hands never sell!", "Patience is power!"]
  - `hodl_power`: ["HODL power!", "Patience pays!", "Long term vision!"]
  - `moon_mission`: ["To the moon!", "Moon mission!", "Rocket fuel!"]
...
- **Moves & Battle Cries**:
  - `royal_profit`: ["Royal profits!", "Queen's strategy!", "Golden opportunity!"]
  - `queen_strike`: ["PnL Baby!", "Short Slash!", "Arbitrage slap!"]
  - `market_dominance`: ["Market domination!", "Delist baby!", "I am OG!"]
...
- **Moves & Battle Cries**:
  ...
  - `corporate_strategy`: ["Corporate power!", "Strategic move!", "Bitcoin treasury!"]
...
- **Moves & Battle Cries**:
  ...
  - `flash_loan`: ["Ninja pool attack!", "Slippaged!", "Front Running!"]
...
- **Moves & Battle Cries**:
  ...
  - `moon_rocket`: ["Kill the jeets!", "Paper hands!", "Rugpull attack!"]
  - `diamond_paws`: ["Diamond paws!", "Meme magic!", "Paws of power!"]
...
- **Moves & Battle Cries**:
  ...
  - `proof_of_stake`: ["Proof of Stake!", "Unicorn Shirt!", "Ethereum 2.0 power!"]
...
- **Moves & Battle Cries**:
  - `binance_blast`: ["Binance power!", "Exchange dominance!", "Volume surge!"]
  - `trading_fury`: ["Trading fury!", "I am the BOSS!", "Binance rage!"]
  - `market_dominance`: ["Market domination!", "Delist baby!", "I am OG!"]
...
- **Moves & Battle Cries**:
  ...
  - `doge_power`: ["Much wow!", "Doge to the moon!", "Sam is Liar!"]
...
- **Moves & Battle Cries**:
  ...
  - `academic_precision`: ["I am not sure strike!", "Only Ico Power!", "Research validated!"]
...
- **Moves & Battle Cries**:
  ...
  - `interop_blast`: ["Interop blast!", "Cross-chain power!", "Universal connection!"]
...
- **Moves & Battle Cries**:
  ...
  - `digital_strike`: ["Crypto for everyone!", "Coinbase strike!", "Crypto adoption!"]
...
- **Moves & Battle Cries**:
  ...
  - `shadow_dash`: ["Shadow dash!", "Base network!", "Invisible strike!"]
...
4. **EXCHANGE_DOLLAR** → `src/assets/sprites/projectiles/exchange-dollar-svgrepo-com.svg`
5. **BITCOIN_CIRCLE** → `src/assets/sprites/projectiles/bitcoin-circle-svgrepo-com.svg`
6. **BLOCKCHAIN_SECURITY** → `src/assets/sprites/projectiles/blockchain-digital-future-system-security-svgrepo-com.svg`
7. **NINJA_STAR** → `src/assets/sprites/projectiles/ninja-star-svgrepo-com.svg`
8. **SWORD_HEAVY** → `src/assets/sprites/projectiles/sword-heavy-svgrepo-com.svg`
9. **ROCKET_ADVANCED** → `src/assets/sprites/projectiles/rocket-svgrepo-com.svg`
10. **MOON_STARS** → `src/assets/sprites/projectiles/moon-and-stars-svgrepo-com.svg`
11. **ETHEREUM_ALT** → `src/assets/sprites/projectiles/ethereum-svgrepo-com_2.svg`
12. **FIRE_BLAST** → `src/assets/sprites/projectiles/fire-svgrepo-com.svg`
13. **BINANCE_COIN** → `src/assets/sprites/projectiles/binance-bnb-coin-2-svgrepo-com.svg`
14. **ANNOUNCEMENT** → `src/assets/sprites/projectiles/announcement-shout-svgrepo-com.svg`
15. **DOGE_COIN** → `src/assets/sprites/projectiles/doge-svgrepo-com.svg`
16. **BITCOIN_LASER** → `src/assets/sprites/projectiles/bitcoin-svgrepo-com.svg`
17. **FIRE_BOMB** → `src/assets/sprites/projectiles/fire-bomb-svgrepo-com.svg`
18. **ETHEREUM_SHARD** → `src/assets/sprites/projectiles/ethereum-svgrepo-com.svg`
...
24. **MOON_CLASSIC** → `src/assets/sprites/projectiles/moon-svgrepo-com.svg`
25. **MOON_ADVANCED** → `src/assets/sprites/projectiles/moon-svgrepo-com_2.svg`
26. **SPACE_BLAST** → `src/assets/sprites/projectiles/space-2-svgrepo-com.svg`
27. **SPACE_COSMOS** → `src/assets/sprites/projectiles/space-pace-cosmos-gravity-svgrepo-com.svg`
28. **TRENDING_DOWN** → `src/assets/sprites/projectiles/trending-down-svgrepo-com.svg`
29. **MEME_ROCKET** → `src/assets/sprites/projectiles/rocket-svgrepo-com.svg`
