...
- **Moves & Battle Cries**:
  ...
  - `market_dominance`: ["Slippage punch!", "Long Position Shock!", "Total control!"]
...
- **Moves & Battle Cries**:
  ...
  - `diamond_paws`: ["Jeet paws!", "Meme magic!", "Shitpost power!"]
...
- **Moves & Battle Cries**:
  ...
  - `interop_blast`: ["Interop blast!", "Crowdloan strike!", "Parachain power!"]
...
- **Moves & Battle Cries**:
  ...
  - `shadow_dash`: ["More UX Baby!", "Base network!", "Web3 adoption!"]
